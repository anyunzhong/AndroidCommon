 ...
 * @version $Id: IOHelper.java 481854 2006-12-03 18:30:07Z scolebourne $
 */
public class IOHelper {
     ...
     * <pre>
     * try {
     *   LineIterator it = IOHelper.lineIterator(reader);
     *   while (it.hasNext()) {
...
//    }
     ...
     * <pre>
     * try {
     *   LineIterator it = IOHelper.lineIterator(stream, "UTF-8");
     *   while (it.hasNext()) {
     *     String line = it.nextLine();
     *     /// do something with line
     *   }
